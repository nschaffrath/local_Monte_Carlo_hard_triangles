...
class Neighborlist_3d
{
    public:
        ...
        bool remove_particle_from_cell_list(Particle* given_particle)
        {
            ...
            {
                auto particle_to_remove = find(cell_list[old_cell_element_x][old_cell_element_y][old_cell_element_z].begin(), 
                                                cell_list[old_cell_element_x][old_cell_element_y][old_cell_element_z].end(), given_particle);

                if( particle_to_remove != cell_list[old_cell_element_x][old_cell_element_y][old_cell_element_z].end())
                {    
                    // Remove the element using erase
                    cell_list[old_cell_element_x][old_cell_element_y][old_cell_element_z].erase(particle_to_remove);
                }
                return true;
            }
        }
